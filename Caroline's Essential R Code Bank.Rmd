...
#now eveything should be connected and you can use the R studio git tab as normal
```
...
#can you use the summary() function

#parametric terms of model: linear terms in the model
...
api_secret <- 'AIzaSyAZMk84DD46I0EMsHm0ZzSD8ATpZPQWKBo' #PLEASE DO NOT USE MY API KEY, MAKE YOUR OWN!
